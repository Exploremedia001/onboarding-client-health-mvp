...
export const ALL_CLIENTS: Client[] = [
  {
    id: 1, name: 'Foundation Health & Wellness', status: 'green', category: 'Health & Wellness',
  ...
  {
    id: 2, name: 'JAG Medical Spa', status: 'yellow', category: 'Medical Spa',
    ...
    aiRecommendations: ['Schedule strategy call', 'Review lead sources', 'Present recovery plan'],
    redFlags: ['Leads down 8%'],
    upsellOpportunity: false, crossSellOpportunity: true, budgetIncreaseSignal: false,
  },
  {
    id: 3, name: 'Vital Roots Functional Medicine', status: 'green', category: 'Medical',
  ...
  {
    id: 4, name: 'Core Wellness & Recovery', status: 'red', category: 'Health & Wellness',
    ...
    aiRecommendations: ['Emergency strategy call', 'Review all lead sources', 'Present recovery plan', 'Assign senior AM'],
    redFlags: ['Revenue down 22%', 'No meeting for 42 days', 'Leads down 22%', 'Deliverables overdue'],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
  {
    id: 5, name: 'Vitality Medical Spa', status: 'green', category: 'Medical Spa',
  ...
  {
    id: 6, name: 'Inner Calm Therapy Center', status: 'yellow', category: 'Therapy',
    ...
    aiRecommendations: ['Increase meeting frequency', 'Send progress report'],
    redFlags: [],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
  {
    id: 7, name: 'Precision HVAC Experts', status: 'green', category: 'HVAC',
  ...
  {
    id: 8, name: 'Apex Climate Control', status: 'red', category: 'HVAC',
    ...
    aiRecommendations: ['Schedule strategy call', 'Review lead sources', 'Audit PPC campaigns'],
    redFlags: ['Revenue down 14%', 'Leads down 15%', 'No meeting for 35 days'],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
  {
    id: 9, name: 'Comfort Zone Heating & Air', status: 'yellow', category: 'HVAC',
    ...
    aiRecommendations: ['Schedule check-in call', 'Review SEO performance'],
    redFlags: ['Leads down 10%'],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
  {
    id: 10, name: 'Elite Air Systems', status: 'green', category: 'HVAC',
  ...
  {
    id: 11, name: 'Rapid Response Air', status: 'red', category: 'HVAC',
    ...
    aiRecommendations: ['Emergency executive call', 'Full account audit', 'Recovery plan presentation', 'Reassign to senior AM'],
    redFlags: ['Revenue down 28%', 'Negative review received', 'No meeting for 48 days', 'Leads down 30%', 'Churn language detected', 'Deliverables overdue'],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
  {
    id: 12, name: 'Pure Air Solutions', status: 'green', category: 'HVAC',
  ...
  {
    id: 13, name: 'Airflow Masters', status: 'yellow', category: 'HVAC',
    ...
    aiFlags: [],
    aiRecommendations: ['Continue recovery plan', 'Schedule quarterly review'],
    redFlags: [],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
  {
    id: 14, name: 'Frosty Systems', status: 'green', category: 'HVAC',
  ...
  {
    id: 15, name: 'Prime Comfort HVAC', status: 'red', category: 'HVAC',
    ...
    aiRecommendations: ['Schedule strategy call', 'Review lead sources', 'Present recovery plan'],
    redFlags: ['Revenue down 18%', 'No meeting for 38 days', 'Leads down 16%'],
    upsellOpportunity: false, crossSellOpportunity: false, budgetIncreaseSignal: false,
  },
];
